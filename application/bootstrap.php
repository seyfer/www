 ...
 */
//на продкшене роуты можно закеширвать
//if ( ! Route::cache() && Kohana::$environment == Kohana::PRODUCTION) {
//роут виджетов
...
//просмотр каталога, категорий, товаров
...
//контакты, не статика т.к. там форма
...
//статические страницы. можно объединить с static
...
//роут для статических страниц. надо создать контроллер
...
//этот иф вынести наверх на продакшене
if (!Route::cache() && Kohana::$environment == Kohana::PRODUCTION)
{
    Route::cache(TRUE);
}
